...
public class MatchAPIService {
    ...
    public MatchAPIService() {
        for (int i = 1; i <= 10; i++) {
            ...
            matchWithScore.setTeam1(new Team(i + "", "Random Team #" + i, new Score(100 % (i + i), 2)));
            matchWithScore.setTeam2(new Team((i * 2) + "", "Random Team #" + (i * 2), new Score(100 % (i), 2)));
